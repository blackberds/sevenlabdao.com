import { ChatType, EventPopupButtonsSet, HapticFeedbackImpactStyle, HapticFeedbackNotification, HexColor, InvoiceStatus, ScanQrPopupParams, ThemeParams } from './common';
 ...
 */
export type WebViewEvent = 'web_app_ready' | 'web_app_expand' | 'web_app_close' | 'web_app_open_popup' | 'web_app_setup_closing_behavior' | 'web_app_set_background_color' | 'web_app_set_header_color' | 'web_app_data_send' | 'web_app_trigger_haptic_feedback' | 'web_app_open_link' | 'web_app_open_tg_link' | 'web_app_open_invoice' | 'web_app_request_viewport' | 'web_app_request_theme' | 'web_app_setup_main_button' | 'web_app_setup_back_button' | 'web_app_open_scan_qr_popup' | 'web_app_close_scan_qr_popup' | 'web_app_read_text_from_clipboard' | 'web_app_switch_inline_query' | 'payment_form_submit' | 'share_score' | 'share_game' | 'game_over' | 'game_loaded' | 'resize_frame';
 ...
 */
export type TriggerHapticFeedbackEventData = ImpactHapticFeedbackData | NotificationHapticFeedbackData | SelectionChangeHapticFeedbackData;
/**
 * @see https://core.telegram.org/api/web-events#web-app-trigger-haptic-feedback
 */
...
export interface WebView {
    ...
    postEvent(event: 'web_app_open_popup', callback: Nullable<PostEventCallback>, data: OpenPopupEventData): void;
    postEvent(event: 'web_app_setup_closing_behavior', callback: Nullable<PostEventCallback>, data: SetupClosingBehaviorEventData): void;
    postEvent(event: 'web_app_set_background_color', callback: Nullable<PostEventCallback>, data: SetBackgroundColorEventData): void;
    postEvent(event: 'web_app_set_header_color', callback: Nullable<PostEventCallback>, data: SetHeaderColorEventData): void;
    postEvent(event: 'web_app_data_send', callback: Nullable<PostEventCallback>, data: DataSendEventData): void;
    postEvent(event: 'web_app_trigger_haptic_feedback', callback: Nullable<PostEventCallback>, data: TriggerHapticFeedbackEventData): void;
    postEvent(event: 'web_app_open_link', callback: Nullable<PostEventCallback>, data: OpenLinkEventData): void;
    postEvent(event: 'web_app_open_tg_link', callback: Nullable<PostEventCallback>, data: OpenTgLinkEventData): void;
    postEvent(event: 'web_app_open_invoice', callback: Nullable<PostEventCallback>, data: OpenInvoiceEventData): void;
    ...
    postEvent(event: 'web_app_setup_main_button', callback: Nullable<PostEventCallback>, data: SetupMainButtonEventData): void;
    postEvent(event: 'web_app_setup_back_button', callback: Nullable<PostEventCallback>, data: SetupBackButtonEventData): void;
    postEvent(event: 'web_app_open_scan_qr_popup', callback: Nullable<PostEventCallback>, data: ScanQrPopupParams): void;
    postEvent(event: 'web_app_close_scan_qr_popup', callback?: Nullable<PostEventCallback>): void;
    postEvent(event: 'web_app_read_text_from_clipboard', callback: Nullable<PostEventCallback>, data: RedTextFromClipboardEventData): void;
    postEvent(event: 'web_app_switch_inline_query', callback: Nullable<PostEventCallback>, data: SwitchInlineQueryEventData): void;
    postEvent(event: 'payment_form_submit', callback: Nullable<PostEventCallback>, data: PaymentFormSubmitEventData): void;
    ...
    postEvent(event: 'resize_frame', callback: Nullable<PostEventCallback>, data: ResizeFrameEventData): void;
    onEvent: <Event extends keyof ReceivedWebViewEventToData = keyof ReceivedWebViewEventToData>(event: Event, callback: EventCallbackWithOptionalData<Event, ReceivedWebViewEventToData[Event]>) => void;
    offEvent: <Event extends keyof ReceivedWebViewEventToData = keyof ReceivedWebViewEventToData>(event: Event, callback: EventCallbackWithOptionalData<Event, ReceivedWebViewEventToData[Event]>) => void;
    callEventCallbacks: <Event extends keyof ReceivedWebViewEventToData = keyof ReceivedWebViewEventToData>(eventType: Event, func: CallEventCallbackHandler<EventCallbackWithOptionalData<Event, ReceivedWebViewEventToData[Event]>>) => void;
    receiveEvent: <Event extends keyof ReceivedWebViewEventToData = keyof ReceivedWebViewEventToData>(eventType: Event, eventData: ReceivedWebViewEventToData[Event]) => void;
}
