 ...
 */
export type WebAppEvent = 'themeChanged' | 'viewportChanged' | 'mainButtonClicked' | 'backButtonClicked' | 'settingsButtonClicked' | 'invoiceClosed' | 'popupClosed' | 'qrTextReceived' | 'clipboardTextReceived';
 ...
 */
export type ChatTypesToChoose = [ChatType] | [ChatType, ChatType] | [ChatType, ChatType, ChatType] | [ChatType, ChatType, ChatType, ChatType];
...
export interface WebApp {
    ...
    onEvent(eventType: 'viewportChanged', eventHandler: (data: ViewportChangedCallbackData) => any): void;
    ...
    onEvent(eventType: 'qrTextReceived', eventHandler: (data: QrTextReceivedCallbackData) => any): void;
    onEvent(eventType: 'clipboardTextReceived', eventHandler: (data: ClipboardTextReceivedCallbackData) => any): void;
    offEvent(eventType: 'themeChanged', eventHandler: NoParamsCallback): void;
    offEvent(eventType: 'viewportChanged', eventHandler: (data: ViewportChangedCallbackData) => any): void;
    ...
    offEvent(eventType: 'invoiceClosed', eventHandler: (data: InvoiceClosedCallbackData) => any): void;
    offEvent(eventType: 'popupClosed', eventHandler: (data: PopupClosedCallbackData) => any): void;
    offEvent(eventType: 'qrTextReceived', eventHandler: (data: QrTextReceivedCallbackData) => any): void;
    offEvent(eventType: 'clipboardTextReceived', eventHandler: (data: ClipboardTextReceivedCallbackData) => any): void;
    /**
